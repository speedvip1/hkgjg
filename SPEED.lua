...
function AddTelegramProfile(parent, Configs)
    local channelLink = Configs.Link or "https://t.me/your_channel"
    local channelImage = Configs.Image or "rbxassetid://0"
    local buttonText = Configs.ButtonText or "Join our Telegram"

    local Frame = SetConfigs(Create("Frame", "TelegramFrame", parent), {
    ...
    local ImageLabel = SetConfigs(Create("ImageLabel", "ChannelImage", Frame), {
    ...
    local JoinButton = SetConfigs(Create("TextButton", "JoinButton", Frame), {
        ...
        TextSize = 16,
        TextColor3 = Configs_HUB.TextColor,
        BackgroundColor3 = Color3.fromRGB(40, 160, 220)
    })
    Corner(JoinButton)
    Stroke(JoinButton, Color3.fromRGB(255,255,255))
...
function AddImageLabel(parent, Configs)
    ...
    local imageSize = Configs.Size or UDim2.new(1, 0, 0, 100)

    local Frame = SetConfigs(Create("Frame", "ImageFrame", parent), {
        Size = imageSize,
        BackgroundColor3 = Configs_HUB.Hub,
        BackgroundTransparency = 0.5
    })
    ...
    local ImageLabel = SetConfigs(Create("ImageLabel", "Image", Frame), {
